# Remove `packages/botconnector/src/storage/db.ts`

## Goal

Remove all production usages of the legacy `packages/botconnector/src/storage/db.ts` module.
...
Production imports from `packages/botconnector/src/storage/db.ts` are concentrated in 22 source files:

- `packages/botconnector/src/account/repo.ts`
- `packages/botconnector/src/cli/cmd/db.ts`
- `packages/botconnector/src/cli/cmd/import.ts`
- `packages/botconnector/src/cli/cmd/stats.ts`
- `packages/botconnector/src/control-plane/workspace.ts`
- `packages/botconnector/src/index.ts`
- `packages/botconnector/src/node.ts`
- `packages/botconnector/src/permission/index.ts`
- `packages/botconnector/src/project/project.ts`
- `packages/botconnector/src/server/projectors.ts`
- `packages/botconnector/src/server/routes/instance/httpapi/handlers/sync.ts`
- `packages/botconnector/src/server/shared/fence.ts`
- `packages/botconnector/src/session/message-v2.ts`
- `packages/botconnector/src/session/projectors.ts`
- `packages/botconnector/src/session/prompt.ts`
- `packages/botconnector/src/session/session.ts`
- `packages/botconnector/src/session/todo.ts`
- `packages/botconnector/src/share/share-next.ts`
- `packages/botconnector/src/storage/db.ts`
- `packages/botconnector/src/sync/index.ts`
- `packages/botconnector/src/worktree/index.ts`
...
Status: Completed. Startup, the public node export, and database CLI tooling no longer import the legacy opencode database wrapper; `packages/botconnector/src/storage/db.ts` has been deleted.
...
All migration groups are complete or superseded. `packages/botconnector/src/storage/db.ts` has been deleted.
...
- Existing schema ownership remains in `packages/core/src/**/*.sql.ts`; do not move table definitions back into `packages/botconnector`.

## Verification Commands

- `rg "@/storage/db|./storage/db|Database\.(use|transaction|effect|Client|getPath)|\bTxOrDb\b|\bTransaction\b" packages/botconnector/src`
- `bun typecheck` from `packages/botconnector`
- Relevant package tests from `packages/botconnector`, not the repo root
