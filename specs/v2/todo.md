...
- remove the public in-memory `@botconnector/llm` tool loop after replacing its
...
- decide whether to preserve deprecated `@botconnector/llm` orchestration exports
