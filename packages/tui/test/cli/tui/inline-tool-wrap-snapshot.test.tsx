...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "OPENCODE.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/botconnector/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/botconnector (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/botconnector/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/botconnector/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const OPENCODE_DB|OPENCODE_DB|OPENCODE_DEV|Global\\.Path\\.data|data =" in packages/botconnector/src (115 matches)',
  },
] as const
