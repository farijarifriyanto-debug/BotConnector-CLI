    ...
    <>
      <box ref={(r: BoxRenderable) => (anchor = r)} visible={props.visible !== false} width="100%">
        <box
          width="100%"
          border={["top"]}
          borderColor={status().type === "idle" ? theme.border : borderHighlight()}
          paddingTop={1}
        >
          <box
            paddingLeft={1}
          ...
          >
            <textarea
              ...
              cursorColor={props.disabled ? theme.textMuted : theme.text}
                      ...
                      <Show when={store.mode === "normal"}>
                        <box flexDirection="row" gap={1}>
                          ...
                          <text fg={fadeColor(theme.textMuted, modelMetaAlpha())}>
                            {currentProviderLabel().toLowerCase().includes("ollama") ? "LOCAL" : "CLOUD"}
                          </text>
