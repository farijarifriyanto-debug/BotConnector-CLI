...
import { compile, emitEffectImported, emitPromise, write } from "@botconnector/httpapi-codegen"
        ...
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              ...
              import: 'import type { OpenCodeEventEncoded } from "@botconnector/protocol/groups/event"',
            },
          },
        }),
