...
export const TypeId: TypeId = "~@botconnector/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@botconnector/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@botconnector/effect-sqlite-node/NodeSqliteClient")
