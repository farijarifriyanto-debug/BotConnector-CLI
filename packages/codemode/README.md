...
{
  "dependencies": {
    "@botconnector/codemode": "workspace:*"
  }
}
```
...
```ts
import { CodeMode, Tool } from "@botconnector/codemode"
...
```ts
import { CodeMode, OpenAPI } from "@botconnector/codemode"
...
```ts
import { toolError } from "@botconnector/codemode"
