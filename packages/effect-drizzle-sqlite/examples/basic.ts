...
class Database extends Context.Service<Database, DatabaseShape>()("@botconnector/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@botconnector/example/UserStore") {
