...
Create `.botconnector/commands/test.md`:

```md title=".botconnector/commands/test.md"
---
...
You can add custom commands through the BotConnector config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your BotConnector [config](/docs/config):

```json title="botconnector.jsonc" {4-12}
{
  "command": {
...
- Global: `~/.config/botconnector/commands/`
- Per-project: `.botconnector/commands/`

```markdown title="~/.config/botconnector/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".botconnector/commands/component.md"
---
...
```md title=".botconnector/commands/create-file.md"
---
...
```md title=".botconnector/commands/analyze-coverage.md"
---
...
```md title=".botconnector/commands/review-changes.md"
---
...
```md title=".botconnector/commands/review-component.md"
---
