---
title: Share
description: Share your BotConnector conversations.
---

BotConnector's share feature allows you to create public links to your BotConnector conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, BotConnector:
...
BotConnector supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, BotConnector uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
...
To enforce this across your team for a given project, add it to the `botconnector.json` in your project and check into Git.
