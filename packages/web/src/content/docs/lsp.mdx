---
title: LSP Servers
description: BotConnector integrates with your LSP servers.
---

BotConnector can integrate with Language Server Protocol (LSP) servers to use diagnostics as feedback for the agent.

---

## Built-in

BotConnector comes with several built-in LSP servers for popular languages:
...
```json title="botconnector.json" {5-8}
{
  "lsp": {
    "rust": {
...
```json title="botconnector.json" {5-13}
{
  "lsp": {
    "custom-lsp": {
