---
title: Ecosystem
description: Projects and integrations built with BotConnector.
---

A collection of community projects built on BotConnector.

:::note
Want to add your BotConnector related project to this list? Submit a PR.
:::
...
| Name                                                                                               | Description                                                                                        |
| -------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytona/integrations/tree/main/packages/botconnector-plugin)     | Automatically run BotConnector sessions in isolated Daytona sandboxes with git sync and live previews  |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Track BotConnector usage with Wakatime                                                                 |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Desktop notifications and sound alerts for BotConnector sessions                                       |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | AI-powered automatic Zellij session naming based on BotConnector context                               |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Allow BotConnector agents to lazy load prompts on demand with skill discovery and injection            |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Native OS notifications for BotConnector – know when tasks complete                                    |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Zero-friction git worktrees for BotConnector                                                           |
...
| [opencode-jfrog-plugin](https://github.com/jfrog/opencode-jfrog-plugin)                            | JFrog Plugin for seamless integration of BotConnector users to JFrog platform                          |
| [opencode-goal-plugin](https://github.com/willytop8/BotConnector-goal-plugin)                          | Session-scoped `/goal` workflow that keeps objectives in context and auto-continues until complete |
...
| Name                                                                                       | Description                                                      |
| ------------------------------------------------------------------------------------------ | ---------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Discord bot to control BotConnector sessions, built on the SDK       |
| [opencode.nvim](https://github.com/NickvanDyke/opencode.nvim)                              | Neovim plugin for editor-aware prompts, built on the API         |
| [portal](https://github.com/hosenur/portal)                                                | Mobile-first web UI for BotConnector over Tailscale/VPN              |
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Template for building BotConnector plugins                           |
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Neovim frontend for opencode - a terminal-based AI coding agent  |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Vercel AI SDK provider for using BotConnector via @opencode-ai/sdk   |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Web / Desktop App and VS Code Extension for BotConnector             |
| [BotConnector-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Obsidian plugin that embeds BotConnector in Obsidian's UI            |
| [OpenWork](https://github.com/different-ai/openwork)                                       | An open-source alternative to Claude Cowork, powered by BotConnector |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | BotConnector extension manager with portable, isolated profiles.     |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Desktop, Web, Mobile and Remote Client App for BotConnector          |
