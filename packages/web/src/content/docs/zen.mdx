---
title: Zen
description: Curated list of models provided by BotConnector.
---
...
BotConnector Zen is a list of tested and verified models provided by the BotConnector team.

Zen works like any other provider in BotConnector. You login to BotConnector Zen and get
...
:::tip
We tested a select group of models and providers that work well with BotConnector.
:::
...
BotConnector Zen is an AI gateway that gives you access to these models.

---

## How it works

BotConnector Zen works like any other provider in BotConnector.

1. You sign in to **<a href={console}>BotConnector Zen</a>**, add your billing
   details, and copy your API key.
2. You run the `/connect` command in the TUI, select BotConnector Zen, and paste your API key.
...
The [model id](/docs/config/#models) in your BotConnector config
...
Use your BotConnector Zen API key with the `https://opencode.ai/zen/v1/systemone` endpoint. This example checks whether a support request is urgent:
...
You may notice [low-cost models](/docs/config/#models), such as Haiku, Nano, or Flash, in your usage history. BotConnector uses these models to generate session titles.
...
- MiMo-V2.6-Flash Free is available on BotConnector for a limited time. The team is using this time to collect feedback and improve the model.
- MiMo-V2.5 Free is available on BotConnector for a limited time. The team is using this time to collect feedback and improve the model.
- Ling 3.0 Flash Fin Free is available on BotConnector for a limited time. The team is using this time to collect feedback and improve the model.
- Nemotron 3 Ultra Free is available on BotConnector for a limited time. The team is using this time to collect feedback and improve the model.
- Nemotron 3.5 Lightning Free is available on BotConnector for a limited time. The team is using this time to collect feedback and improve the model.
- Big Pickle is a stealth model that's free on BotConnector for a limited time. The team is using this time to collect feedback and improve the model.
- Muse Spark 1.3 Contributor Free is available on BotConnector for a limited time. The team is using this time to collect feedback and improve the model.
- Jev 1.13 Free is available on BotConnector for a limited time.
...
We created BotConnector Zen to:
...
4. Have **no lock-in** by allowing you to use it with any other coding agent. And always let you use any other provider with BotConnector as well.
