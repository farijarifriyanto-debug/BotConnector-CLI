import { OpenCode } from "@botconnector/client/effect"
...
import { createEmbeddedRoutes } from "@botconnector/server/routes"
...
export class Service extends Context.Service<Service, Interface>()("@botconnector/sdk-next/OpenCode") {}
