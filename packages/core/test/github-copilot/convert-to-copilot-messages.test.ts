import { convertToOpenAICompatibleChatMessages as convertToCopilotMessages } from "@botconnector/core/github-copilot/chat/convert-to-openai-compatible-chat-messages"
