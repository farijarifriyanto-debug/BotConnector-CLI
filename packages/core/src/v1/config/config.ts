...
export const Info = Schema.Struct({
  ...
  server: Schema.optional(ConfigServerV1.Server).annotate({
    description: "Server configuration for BotConnector serve commands",
  }),
  command: Schema.optional(Schema.Record(Schema.String, ConfigCommandV1.Info)).annotate({
    description: "Command configuration for BotConnector",
  }),
  ...
  ).annotate({ description: "Agent configuration for BotConnector" }),
