...
export const Flag = {
  ...
  BOTCONNECTOR_SERVER_PASSWORD:
    process.env["BOTCONNECTOR_SERVER_PASSWORD"] ?? process.env["OPENCODE_SERVER_PASSWORD"],
  BOTCONNECTOR_SERVER_USERNAME:
    process.env["BOTCONNECTOR_SERVER_USERNAME"] ?? process.env["OPENCODE_SERVER_USERNAME"],
