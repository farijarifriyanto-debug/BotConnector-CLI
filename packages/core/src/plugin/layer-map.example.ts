...
export class RequestContextRef extends Context.Service<RequestContextRef, RequestContext>()(
  "@botconnector/example/RequestContextRef",
) {}
...
export class ConfigService extends Context.Service<ConfigService, ConfigServiceShape>()(
  "@botconnector/example/ConfigService",
) {}
...
export class ConfigServiceMap extends LayerMap.Service<ConfigServiceMap>()("@botconnector/example/ConfigServiceMap", {
