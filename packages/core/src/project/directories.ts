...
import type { EffectDrizzleSqlite } from "@botconnector/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@botconnector/ProjectDirectories") {}
