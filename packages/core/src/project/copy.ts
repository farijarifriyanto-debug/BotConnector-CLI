...
import { Event } from "@botconnector/schema/project-directories"
import { ProjectCopy } from "@botconnector/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@botconnector/ProjectCopy") {}
