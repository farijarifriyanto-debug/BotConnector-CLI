...
import { Credential } from "@botconnector/schema/credential"
import { Integration } from "@botconnector/schema/integration"
...
export class Service extends Context.Service<Service, Interface>()("@botconnector/v2/Credential") {}
