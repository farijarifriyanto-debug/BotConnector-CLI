...
import { FileSystemWatcher } from "@botconnector/schema/filesystem-watcher"
...
export class Service extends Context.Service<Service, Interface>()("@botconnector/v2/FileWatcher") {}
