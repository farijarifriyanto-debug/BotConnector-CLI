...
import { Entry, FileSystem, FindInput, Match } from "@botconnector/schema/filesystem"
export { Entry, Match, Submatch } from "@botconnector/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@botconnector/v2/FileSystem") {}
