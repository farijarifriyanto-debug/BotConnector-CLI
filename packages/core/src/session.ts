...
import { ListAnchor } from "@botconnector/schema/session"
...
import { PromptInput } from "@botconnector/schema/prompt-input"
...
import { SessionDurable } from "@botconnector/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@botconnector/v2/Session") {}
