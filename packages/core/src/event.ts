...
import type { Data, Definition, Payload } from "@botconnector/schema/event"
...
import { Durable } from "@botconnector/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@botconnector/schema/event").ID
export type { Data, Definition, Payload } from "@botconnector/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@botconnector/Event") {}
