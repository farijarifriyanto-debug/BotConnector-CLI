...
export { Effect, Rule, Ruleset } from "@botconnector/schema/permission"
...
export class Service extends Context.Service<Service, Interface>()("@botconnector/v2/Permission") {}
