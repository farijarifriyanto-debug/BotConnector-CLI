...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@botconnector/llm"
...
export class Service extends Context.Service<Service, Interface>()("@botconnector/v2/ToolRegistry") {}
