...
import { PermissionSaved } from "@botconnector/schema/permission-saved"
...
export class Service extends Context.Service<Service, Interface>()("@botconnector/v2/PermissionSaved") {}
