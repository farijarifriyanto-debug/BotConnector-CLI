...
import { and, Database, eq, isNull } from "@botconnector/console-core/drizzle/index.js"
import { BillingTable, LiteTable } from "@botconnector/console-core/schema/billing.sql.js"
    ...
    return new Response(
      JSON.stringify({
        ...
        error: {
          ...
          message: "BotConnector Go subscription required.",
        },
      }),
      {
        status: 403,
