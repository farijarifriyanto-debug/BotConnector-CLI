...
import { TuiKeybind } from "@botconnector/tui/config/keybind"
...
import { TuiConfig } from "@botconnector/tui/config"
...
export class Service extends Context.Service<Service, Interface>()("@botconnector/TuiConfig") {}
