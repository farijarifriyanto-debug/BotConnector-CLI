...
import { AbsolutePath, type DeepMutable } from "@botconnector/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@botconnector/Agent") {}
          ...
          plan: {
            ...
            permission: Permission.merge(
              ...
              Permission.fromConfig({
                ...
                edit: {
                  "*": "deny",
                  [path.join(".botconnector", "plans", "*.md")]: "allow",
