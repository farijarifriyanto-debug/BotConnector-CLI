...
export const UninstallCommand = {
  command: "uninstall",
  describe: "uninstall BotConnector and remove all related files",
  builder: (yargs: Argv) =>
    yargs
      .option("keep-config", {
        alias: "c",
  ...
  handler: async (args: UninstallArgs) => {
    ...
    UI.println(UI.logo("  "))
    UI.empty()
    prompts.intro("Uninstall BotConnector")
...
async function showRemovalSummary(targets: RemovalTargets, method: Installation.Method) {
  ...
  if (method !== "curl" && method !== "unknown") {
    const cmds: Record<string, string> = {
      npm: "npm uninstall -g @botconnector/bccli",
      pnpm: "pnpm uninstall -g @botconnector/bccli",
      bun: "bun remove -g @botconnector/bccli",
...
async function executeUninstall(method: Installation.Method, targets: RemovalTargets) {
  ...
  if (method !== "curl" && method !== "unknown") {
    const cmds: Record<string, string[]> = {
      ...
      pnpm: ["pnpm", "uninstall", "-g", "@botconnector/bccli"],
      bun: ["bun", "remove", "-g", "@botconnector/bccli"],
      yarn: ["yarn", "global", "remove", "@botconnector/bccli"],
      brew: ["brew", "uninstall", "botconnector"],
      choco: ["choco", "uninstall", "botconnector"],
      scoop: ["scoop", "uninstall", "botconnector"],
    }
  ...
  UI.empty()
  prompts.log.success("Thank you for using BotConnector!")
}
