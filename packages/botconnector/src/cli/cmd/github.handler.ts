  ...
  yield* Effect.promise(async () => {
    {
      ...
      function printNextSteps() {
        ...
        prompts.outro(
          [
            ...
            "",
            "   Learn more about the GitHub agent - https://github.com/farijarifriyanto-debug/BotConnector-CLI",
          ].join("\n"),
        )
      }
      ...
      async function installGitHubApp() {
        ...
        async function getInstallation() {
          return await fetch(`https://api.botconnector.id/unsupported-github-agent`)
            .then((res) => res.json())
...
export const githubRun = Effect.fn("Cli.github.run")(function* (args: { event?: string; token?: string }) {
  ...
  yield* Effect.promise(async () => {
    ...
    const shareBaseUrl = "https://app.botconnector.id"
    ...
    try {
      ...
      console.log("botconnector session", session.id)
    ...
    function normalizeOidcBaseUrl(): string {
      ...
      if (!value) return "https://api.botconnector.id"
