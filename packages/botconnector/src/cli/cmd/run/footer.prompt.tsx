...
import { normalizePromptContent } from "@botconnector/tui/editor"
...
import { OPENCODE_BASE_MODE, useBindings } from "@botconnector/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close BotConnector" } satisfies SlashOption,
    ]
