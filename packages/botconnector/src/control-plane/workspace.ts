...
import { EventSequenceTable, EventTable } from "@botconnector/core/event/sql"
...
import { WorkspaceEvent } from "@botconnector/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@botconnector/Workspace") {}
