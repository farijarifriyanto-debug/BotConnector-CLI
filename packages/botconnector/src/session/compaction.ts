...
import { buildPrompt } from "@botconnector/core/session/compaction"
import { SessionCompactionEvent } from "@botconnector/schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("@botconnector/SessionCompaction") {}
