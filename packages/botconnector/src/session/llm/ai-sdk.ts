import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@botconnector/llm"
...
// Move this extraction into @botconnector/llm when Copilot is handled by the native runtime.
