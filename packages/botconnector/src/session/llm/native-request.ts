import type { JsonSchema, LLMRequest, ProviderMetadata } from "@botconnector/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@botconnector/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @botconnector/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
