...
import { PermissionV1 } from "@botconnector/core/v1/permission"
import { Slug } from "@botconnector/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@botconnector/llm"
...
import { locationServiceMapLayer } from "@botconnector/core/location-services"
...
import { PartTable, SessionTable } from "@botconnector/core/session/sql"
...
import { WorkspaceV2 } from "@botconnector/core/workspace"
import { SessionID, MessageID, PartID } from "./schema"

import type { Provider } from "@/provider/provider"
import { Global } from "@botconnector/core/global"
import { Effect, Layer, Option, Context, Schema, Types } from "effect"
import { NonNegativeInt, optional } from "@botconnector/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".botconnector", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@botconnector/Session") {}
