...
import { MAX_STEPS_PROMPT } from "@botconnector/core/session/runner/max-steps"
...
import { LLMEvent } from "@botconnector/llm"
...
export class Service extends Context.Service<Service, Interface>()("@botconnector/SessionPrompt") {}
      ...
      function* (sessionID: SessionID) {
        ...
        while (true) {
          ...
          const outcome: "break" | "continue" = yield* Effect.gen(function* () {
            ...
            const system = SystemPrompt.orderContext({
              providerID: model.providerID,
              env,
              instructions,
              mcpInstructions,
