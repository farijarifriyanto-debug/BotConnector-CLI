...
import { path } from "@botconnector/core/effect/app-node-platform"
...
import type { ProjectV2 } from "@botconnector/core/project"
...
import { WorktreeEvent } from "@botconnector/schema/worktree-event"
...
export class Service extends Context.Service<Service, Interface>()("@botconnector/Worktree") {}
  ...
  Effect.gen(function* () {
    ...
    const candidate = Effect.fn("Worktree.candidate")(function* (input: {
      ...
      for (const attempt of Array.from({ length: MAX_NAME_ATTEMPTS }, (_, i) => i)) {
        ...
        const branch = input.detached ? undefined : `botconnector/${name}`
