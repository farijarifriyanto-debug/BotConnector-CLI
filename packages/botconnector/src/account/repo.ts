...
import { AccountStateTable, AccountTable } from "@botconnector/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@botconnector/AccountRepo") {}
