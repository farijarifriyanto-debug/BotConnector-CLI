...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@botconnector/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@botconnector/ACPDirectory") {}
