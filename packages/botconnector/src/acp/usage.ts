...
import type { AssistantMessage as BotConnectorAssistantMessage, Message } from "@opencode-ai/sdk/v2"
import { InstanceRef } from "@/effect/instance-ref"
import { InstanceBootstrap } from "@/project/bootstrap"
import { InstanceStore } from "@/project/instance-store"
import { makeGlobalNode, Node } from "@botconnector/core/effect/app-node"
...
export type AssistantTokenCost = Pick<BotConnectorAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<BotConnectorAssistantMessage, "role"> &
  Partial<Pick<BotConnectorAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@botconnector/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@botconnector/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@botconnector/ACPUsage") {}
