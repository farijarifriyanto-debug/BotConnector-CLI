...
import { SkillPlugin } from "@botconnector/core/plugin/skill"
import { Permission } from "@/permission"
import { FSUtil } from "@botconnector/core/fs-util"
import { Config } from "@/config/config"
import { FrontmatterError } from "@botconnector/core/v1/config/error"
import { ConfigMarkdown } from "@/config/markdown"
import { RuntimeFlags } from "@/effect/runtime-flags"
import { Glob } from "@botconnector/core/util/glob"
...
const discoverSkills = Effect.fnUntraced(function* (
  ...
  for (const dir of configDirs) {
    yield* scan(state, dir, BOTCONNECTOR_SKILL_PATTERN)
  }
...
export class Service extends Context.Service<Service, Interface>()("@botconnector/Skill") {}
  ...
  Effect.gen(function* () {
    ...
    const state = yield* InstanceState.make(
      Effect.fn("Skill.state")(function* () {
        ...
        s.skills[CUSTOMIZE_BOTCONNECTOR_SKILL_NAME] = {
          name: CUSTOMIZE_BOTCONNECTOR_SKILL_NAME,
          description: CUSTOMIZE_BOTCONNECTOR_SKILL_DESCRIPTION,
          location: "<built-in>",
          content: CUSTOMIZE_BOTCONNECTOR_SKILL_BODY,
        }
