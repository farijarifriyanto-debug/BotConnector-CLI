...
import { httpClient, path } from "@botconnector/core/effect/app-node-platform"
...
export class Service extends Context.Service<Service, Interface>()("@botconnector/SkillDiscovery") {}
