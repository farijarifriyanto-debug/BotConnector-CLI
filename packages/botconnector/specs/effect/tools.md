...
Practical reference for the current tool-migration state in `packages/botconnector`.
...
Tool tests should use the existing Effect helpers in `packages/botconnector/test/lib/effect.ts`:
