...
describe("parsePluginSpecifier", () => {
  ...
  test("parses scoped npm package without version", () => {
    expect(parsePluginSpecifier("@botconnector/acme")).toEqual({
      pkg: "@botconnector/acme",
      version: "latest",
    })
  })

  test("parses scoped npm package with version", () => {
    expect(parsePluginSpecifier("@botconnector/acme@1.0.0")).toEqual({
      pkg: "@botconnector/acme",
      version: "1.0.0",
    })
  })
  ...
  test("parses scoped package with git+https url", () => {
    expect(parsePluginSpecifier("@botconnector/acme@git+https://github.com/opencode/acme.git")).toEqual({
      pkg: "@botconnector/acme",
      version: "git+https://github.com/opencode/acme.git",
    })
  })
  ...
  test("parses scoped package with git+ssh url containing another @", () => {
    expect(parsePluginSpecifier("@botconnector/acme@git+ssh://git@github.com/opencode/acme.git")).toEqual({
      pkg: "@botconnector/acme",
      version: "git+ssh://git@github.com/opencode/acme.git",
    })
  })
