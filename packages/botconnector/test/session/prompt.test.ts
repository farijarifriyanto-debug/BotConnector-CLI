...
import { NamedError } from "@botconnector/core/util/error"
...
import { SessionMessageTable } from "@botconnector/core/session/sql"
...
import { Shell } from "@botconnector/core/shell"
...
import { LocationServiceMap, locationServiceMapLayer } from "@botconnector/core/location-services"
...
it.instance("does not loop empty assistant turns for a simple reply", () =>
  Effect.gen(function* () {
    ...
    yield* llm.text("packages/botconnector/src/session/processor.ts")
